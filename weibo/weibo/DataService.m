...
+ (void)sendWeibo:(NSMutableDictionary *)params
    ...
    [DataService requestUrl:senfWeibo httpMethod:@"POST" params:params block:block];
...
//        NSLog(@"%@",[DataService requestAFUrl:SendImage httpMethod:@"POST" params:params data:nil block:block]);
        return  [DataService requestAFUrl:senfWeibo httpMethod:@"POST" params:params data:nil block:block];
    ...
    return [DataService requestAFUrl:SendImage httpMethod:@"POST" params:params data:dataDic block:block];
